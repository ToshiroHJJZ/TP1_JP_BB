...
# MLR on Remote Ratio
split=sample.split(dataset2$remote_ratio,SplitRatio = .8)
...
#simple linear regression between salary and work year
...
#single prediction for the year 2023
new=data.frame(work_year=2023)
#value of the house
predict(regressor_SLR,newdata = new)

#single prediction for the year 2022
new=data.frame(work_year=2022)
predict(regressor_SLR,newdata = new)

#single prediction for the year 2021
new=data.frame(work_year=2021)
predict(regressor_SLR,newdata = new)

#single prediction for the year 2020
